...
public class TripWeb {
    ...
    public String createTrip(@RequestBody String request) {
        ...
        tripHib.createTrip(new Trip(Integer.parseInt(data.getProperty("cargoId")),data.getProperty("startPoint"),data.getProperty("destination"), LocalTime.parse(data.getProperty("stopTime")), data.getProperty("stopLocation"), UserHib.getUserById(Integer.parseInt(data.getProperty("driver")))));
